...
echo "Generating tools README for src/universal_mcp_box/app.py..."
universal_mcp readme src/universal_mcp_box/app.py

# Stage the changed file
git add pyproject.toml src/universal_mcp_box/README.md
