...
class BoxApp(APIApplication):
    def __init__(self, integration: Integration = None, **kwargs) -> None:
        super().__init__(name='boxapp', integration=integration, **kwargs)
    ...
    def list_tools(self):
        return [
            self.get_authorize,
            self.post_oauth2_token,
            self.post_oauth2_token_refresh,
            self.post_oauth2_revoke,
            self.get_files_id,
            self.post_files_id,
            self.put_files_id,
            ...
            self.put_files_id_metadata_enterprise_security_classification_6_vmvochw_uwo,
            ...
            self.put_files_id_metadata_global_box_skills_cards,
            ...
            self.put_folders_id_metadata_enterprise_security_classification_6_vmvochw_uwo,
            ...
            self.put_metadata_templates_enterprise_security_classification_6_vmvochw_uwo_schema_update,
            self.get_metadata_templates_id_id_schema,
            self.put_metadata_templates_id_id_schema,
